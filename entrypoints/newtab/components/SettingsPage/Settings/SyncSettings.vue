...
function errorKey(error: unknown): string {
  ...
  if (apiError.message === 'invalid_json') return 'invalidJson'
  if (apiError.message === 'invalid_updated_at') return 'invalidUpdatedAt'
  if (apiError.message === 'invalid_base') return 'invalidBase'
  if (apiError.message === 'invalid_settings') return 'invalidSettings'
  if (apiError.message === 'invalid_version') return 'invalidVersion'
